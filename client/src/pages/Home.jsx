      ...
      <div name='home' className='bg-[#ffffff] text-gray-300 w-full h-auto font-bold md:h-screen '>
        <div className='w-full p-2 grid align-middle'>
          ...
          <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4 mt-[8%]'>
            {/* title */}
            <div className="m-5">
              <h1 className="text-8xl font-semibold  text-[#001e3b] tracking-tight md:text-base">Welcome to Event Share!</h1>
              <h2 className="text-4xl font-medium  text-black leading-tight my-10">One Goal. One Passion.<br />Event Booking Made Easy.</h2>
            </div>
            ...
            <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div className="p-6">
                      ...
                      <p className="mb-4 text-black text-sm font-normal text-left dark:text-neutral-50">
